            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3" style="margin-top: 50px;">
                    <div class="well bs-component">
                        <form class="form-horizontal" role="form" method="POST" action="https://pigjian.com/login">
                            <input type="hidden" name="_token" value="IytVeX9uNLmzYsarsc9Kjjlna5cM1sRInDO5b4NI">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <div class="col-md-8 col-md-offset-2 text-center">
                                        <a class="btn btn-link" href="https://pigjian.com/password/reset">
                                            忘记密码？
                                        </a>
                                    </div>
                                </div>

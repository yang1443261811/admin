...
<head>
    ...
    <script>
        ...
        window.User = {
            ...
            "created_at": "2018-11-01 05:13:34"
        }
 ...
 */
    ...
    <script type="text/javascript" charset="utf-8" async="" src="/js/3.59c47e1ae3533cca6170.js"></script>
    <script type="text/javascript" charset="utf-8" async="" src="/js/18.a844f563b40109686a1e.js"></script>
    ...
    <style type="text/css">
        ...
        .sidebar-nav > .sidebar-brand[data-v-0abac408] {
            height: 65px;
            font-size: 18px;
            line-height: 60px;
        }

        .sidebar-nav > .sidebar-brand a[data-v-0abac408] {
            color: #999999;
        }

        .sidebar-nav > .sidebar-brand a[data-v-0abac408]:hover {
            color: #fff;
            background: none;
        }
    </style>
    <style type="text/css">
        ...
        .table[data-v-6750c142] {
            border-bottom: 1px solid #e7eaec;
        }

        .none[data-v-6750c142] {
            color: #ECF0F1;
            padding-bottom: 20px;
        }

        .actions[data-v-6750c142] {
            width: 15%;
            padding: 12px 0px;
            text-align: center;
        }

        .actions a[data-v-6750c142] {
            display: inline-block;
            border-radius: 50%;
            width: 2.2rem;
            height: 2.2rem;
        ...
        .actions a i[data-v-6750c142] {
            font-size: 0.8rem;
        }
    </style>
    <style type="text/css">
        span[data-v-453bbac3] {
            cursor: pointer;
        }
    </style>
    <style type="text/css">
        .active[data-v-551c9b7c] {
            background-color: #3d4e60;
            border-right: none;
        }

        .pagination li[data-v-551c9b7c] {
            cursor: pointer;
        }
    </style>
    <script type="text/javascript" charset="utf-8" async="" src="/js/24.2c53862c384c91f5d5c2.js"></script>
    <script type="text/javascript" charset="utf-8" async="" src="/js/21.c4776eeb15fad4cc5d7d.js"></script>
    <script type="text/javascript" charset="utf-8" async="" src="/js/22.3e8214543d366455c3cf.js"></script>
    <script type="text/javascript" charset="utf-8" async="" src="/js/16.1983c796ea13fcaea4d9.js"></script>
    <style type="text/css">
        .ibox-content .btn[data-v-eb55ec6c] {
            display: inline-block;
            border-radius: 50%;
            width: 2.2rem;
            height: 2.2rem;
    ...
    <style type="text/css">
        ...
        .modal-header[data-v-5f2bf8a1] {
            padding-bottom: 25px;
            border: none;
        }

        .modal-dialog[data-v-5f2bf8a1] {
            vertical-align: middle;
            margin: 30px auto;
        }

        .modal-content[data-v-5f2bf8a1] {
            background-color: #fff;
            border-radius: 5px;
        ...
        .modal-enter .modal-content[data-v-5f2bf8a1],
        .modal-leave-active .modal-content[data-v-5f2bf8a1] {
            -webkit-transform: scale(1.1);
            transform: scale(1.1);
        }
    </style>
    <script type="text/javascript" charset="utf-8" async="" src="/js/19.c3c787c6964ede5060a5.js"></script>
    <script type="text/javascript" charset="utf-8" async="" src="/js/23.db4ae7f40fdc32a917d6.js"></script>
    <script type="text/javascript" charset="utf-8" async="" src="/js/20.7c1227bc88b1e2846d4f.js"></script>
    <script type="text/javascript" charset="utf-8" async="" src="/js/17.eae02b3ab378e7addaf2.js"></script>
    <script type="text/javascript" charset="utf-8" async="" src="/js/15.c0a7a803c9c9f2b2d32b.js"></script>
    <style type="text/css">
        h2[data-v-8c9bafac] {
            font-size: 20px;
            line-height: 30px;
    ...
    <script type="text/javascript" charset="utf-8" async="" src="/js/9.3d2af775c0a5e53ddf83.js"></script>
    <script type="text/javascript" charset="utf-8" async="" src="/js/2.ace5e6ef7e0fc7e6e634.js"></script>
    <style type="text/css">
...
<div id="wrapper" class="">
    <div data-v-0abac408="" id="sidebar-wrapper">
        <ul data-v-0abac408="" class="sidebar-nav">
            <div data-v-0abac408="" class="user">
                <div data-v-0abac408="" class="avatar">
                    <img data-v-0abac408="" class="img-fluid rounded-circle" src="data:image/png;base64," />
                </div>
                <div data-v-0abac408="" class="nickname">
                    <p data-v-0abac408="">yqm</p>
            ...
            <li data-v-0abac408=""><a data-v-0abac408="" href="/dashboard/home" class=""><i data-v-0abac408="" class="fas fa-tachometer-alt"></i> Dashboard </a></li>
            <li data-v-0abac408=""><a data-v-0abac408="" href="/dashboard/users/" class=""><i data-v-0abac408="" class="fas fa-users"></i> Users </a></li>
            <li data-v-0abac408=""><a data-v-0abac408="" href="/dashboard/articles/" class="active"><i data-v-0abac408="" class="fas fa-book"></i> Articles </a></li>
            <li data-v-0abac408=""><a data-v-0abac408="" href="/dashboard/discussions/" class=""><i data-v-0abac408="" class="fas fa-question-circle"></i> Discussion </a></li>
            <li data-v-0abac408=""><a data-v-0abac408="" href="/dashboard/comments/" class=""><i data-v-0abac408="" class="fas fa-comments"></i> Comments </a></li>
            <li data-v-0abac408=""><a data-v-0abac408="" href="/dashboard/files" class=""><i data-v-0abac408="" class="fas fa-folder"></i> Files </a></li>
            <li data-v-0abac408=""><a data-v-0abac408="" href="/dashboard/tags/" class=""><i data-v-0abac408="" class="fas fa-tags"></i> Tags </a></li>
            <li data-v-0abac408=""><a data-v-0abac408="" href="/dashboard/categories/" class=""><i data-v-0abac408="" class="fas fa-list-alt"></i> Categories </a></li>
            <li data-v-0abac408=""><a data-v-0abac408="" href="/dashboard/links/" class=""><i data-v-0abac408="" class="fas fa-globe"></i> Links </a></li>
            <li data-v-0abac408=""><a data-v-0abac408="" href="/dashboard/visitors" class=""><i data-v-0abac408="" class="fas fa-eye"></i> Visitors </a></li>
            <li data-v-0abac408=""><a data-v-0abac408="" href="/dashboard/system" class=""><i data-v-0abac408="" class="fas fa-cogs"></i> Systems </a></li>
        </ul>
    </div>
                                ...
                                <div data-v-8181b19c="" class="col-sm-12">
                                    <div data-v-8181b19c="" class="form-group row">
                                        ...
                                        <div data-v-8181b19c="" class="col-sm-10">
                                            <div data-v-8181b19c="" tabindex="-1" class="multiselect">
                                                <div class="multiselect__select"></div>
                                                <div class="multiselect__tags">
                                                    <div class="multiselect__tags-wrap" style="display: none;"></div>
                                                    <!---->
                                                    <div class="multiselect__spinner" style="display: none;"></div>
                                                    <input name="" type="text" autocomplete="off" placeholder="Select Categories" tabindex="0" class="multiselect__input" style="width: 0px; position: absolute; padding: 0px;" />
                                                    <!---->
                                                    <span class="multiselect__placeholder"> Select Categories </span>
                                                </div>
                                                <div tabindex="-1" class="multiselect__content-wrapper" style="max-height: 300px; display: none;">
                                                    <ul class="multiselect__content" style="display: inline-block;">
                                                        <!---->
                                                        <li class="multiselect__element"><span data-select="Press enter to select" data-selected="Selected" data-deselect="Press enter to remove" class="multiselect__option multiselect__option--highlight"><span>Marcelle Prohaska</span></span>
                                                            <!----></li>
                                                        <li class="multiselect__element"><span data-select="Press enter to select" data-selected="Selected" data-deselect="Press enter to remove" class="multiselect__option"><span>Miss Anastasia Will</span></span>
                                                            <!----></li>
                                                        <li class="multiselect__element"><span data-select="Press enter to select" data-selected="Selected" data-deselect="Press enter to remove" class="multiselect__option"><span>Adela West V</span></span>
                                                            <!----></li>
                                                        <li class="multiselect__element"><span data-select="Press enter to select" data-selected="Selected" data-deselect="Press enter to remove" class="multiselect__option"><span>Neva Kertzmann</span></span>
                                                            <!----></li>
                                                        <li class="multiselect__element"><span data-select="Press enter to select" data-selected="Selected" data-deselect="Press enter to remove" class="multiselect__option"><span>Ray Block</span></span>
                                                            <!----></li>
                                                        <li class="multiselect__element"><span data-select="Press enter to select" data-selected="Selected" data-deselect="Press enter to remove" class="multiselect__option"><span>Preston Marvin</span></span>
                                                            <!----></li>
                                                        <li class="multiselect__element"><span data-select="Press enter to select" data-selected="Selected" data-deselect="Press enter to remove" class="multiselect__option"><span>Madison Mueller</span></span>
                                                            <!----></li>
                                                        <li class="multiselect__element"><span data-select="Press enter to select" data-selected="Selected" data-deselect="Press enter to remove" class="multiselect__option"><span>Jameson Bayer</span></span>
                                                            <!----></li>
                                                        <li class="multiselect__element"><span data-select="Press enter to select" data-selected="Selected" data-deselect="Press enter to remove" class="multiselect__option"><span>Gracie Fadel</span></span>
                                                            <!----></li>
                                                        <li class="multiselect__element"><span data-select="Press enter to select" data-selected="Selected" data-deselect="Press enter to remove" class="multiselect__option"><span>Keely Becker</span></span>
                                                            <!----></li>
                                    ...
                                    <div data-v-8181b19c="" class="form-group row">
                                        ...
                                        <div data-v-8181b19c="" class="col-sm-10">
                                            <textarea data-v-8181b19c="" id="editor" style="display: none;"></textarea>
                                                        ...
                                                        <div style="position: relative; top: 0px;">
                                                            <div class="CodeMirror-lines">
                                                                <div style="position: relative; outline: none;">
                                                                    <pre class="CodeMirror-placeholder" style="height: 0px; overflow: visible;">Please input the article content.</pre>
                                        ...
                                        <div data-v-8181b19c="" class="col-sm-10">
                                            <div data-v-3faef998="" data-v-8181b19c="" class="cov-vue-date">
                                                <div data-v-3faef998="" class="datepickbox">
                                                    <input data-v-3faef998="" type="text" title="input date" readonly="readonly" placeholder="Published At?" class="cov-datepicker" style="display: inline-block; padding: 6px 6px 6px 10px; height: 41px; line-height: 22px; font-size: 13px; border: 1px solid rgb(220, 228, 236); border-radius: 6px; color: rgb(95, 95, 95);" />
                                                </div>
                                                <!---->
                                            </div>
                                        </div>
...
<script src="/js/app.js?id=deae37cf63f63ff3874b"></script>
</body>
</html>